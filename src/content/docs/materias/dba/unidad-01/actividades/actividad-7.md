...
evidencias del programa oficial (fila "I": "Mapa de responsabilidades del
DBA y diagnóstico de un entorno de base de datos").
...
El docente describirá un entorno de base de datos (relacional o NoSQL,
sin necesidad de acceso a un servidor real). A partir de esa descripción,
elabora:
...
Mapa de responsabilidades + diagnóstico de entorno (documento único).
