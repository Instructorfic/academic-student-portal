...
Este es el guion de la presentación de clase de la unidad. Repasa las
mismas ideas del manual, agrupadas por bloque de diapositivas.
...
> de la que dependen personas reales no termine en esa situación?
...
**Actividad 7 · Diagnóstico integral.** Es la evidencia oficial de la
unidad: responsabilidades, ambientes y arquitectura del entorno asignado.
...
comprensión antes de seguir): ¿qué hace un DBA?, ¿qué
...
De la administración a la seguridad: más adelante en la materia vas a aplicar
